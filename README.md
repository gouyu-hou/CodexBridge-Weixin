...
[CodexBridge Weixin Admin v0.1.1](https://github.com/gouyu-hou/CodexBridge-Weixin/releases/tag/v0.1.1)

普通用户只需要下载：

```text
CodexBridge-Weixin-Admin-Setup-0.1.1.exe
```
...
1. 下载并安装 `CodexBridge-Weixin-Admin-Setup-0.1.1.exe`
